const packages = [
  {
    ...
    tabContent: (
      <div className="text-jacarta-700 dark:text-jacarta-300">
        ...
        <h6 className="mt-2 font-DmSans font-semibold"> Headline Sponsor Investment: ₦2 Million </h6>
      </div>
    )
  },
  {
  ...
  },
  {
    ...
    tabContent: (
      <div className="text-jacarta-700 dark:text-jacarta-300">
        ...
        <h6 className="mt-2 font-DmSans font-semibold">Estimated Package Value:  ₦5 Million </h6>
      </div>
    )
  },
  {
    ...
    tabContent: (
      <div className="text-jacarta-700 dark:text-jacarta-300">
        ...
        <h6 className="mt-2 font-DmSans font-semibold">Category Sponsor Investment: ₦500.000 Million</h6>
      </div>
    )
  }
];
