...
export const Header = ({ homePage }) => {
  ...
  return (
    <>
      ...
      <Menu open={open}>
        <div className="sticky top-0 mx-4  bg-white dark:bg-jacarta-800 z-50">
          <div className="flex  bg-white dark:bg-jacarta-800 z-50 items-center px-3 pb-3 pt-4 justify-between">
            <span className="shrink-0">
              <LogoSwitch />
            </span>
        ...
        <div className="relative mt-10 overflow-y-auto mx-7 ">
          <MenuContainer>
            ...
            <nav className="navbar w-full">
              <ul className="flex flex-col lg:flex-row">
                <li onClick={showDropdown1} className=" group relative">
                  <a
                    href="#"
                    className="text-jacarta-700 hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5"
                    aria-expanded="false"
                  ...
                  >
                    <li>
                      <a
                        ...
                        className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                      >
                        <span className="text-accent text-sm">Home 1</span>
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                      >
                        <span className="text-jacarta-700 text-sm dark:text-white">Home 2</span>
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                      >
                        <span className="text-jacarta-700 text-sm dark:text-white">Home 3</span>
                      </a>
                    </li>
                  </ul>
                  }
                  ...
                  >
                    <li>
                      <a
                        ...
                        className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                      >
                        <span className="text-jacarta-700 text-sm dark:text-white">Item Details</span>
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                      >
                        <span className="text-jacarta-700 text-sm dark:text-white">Explore Collections</span>
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                      >
                        <span className="text-jacarta-700 text-sm dark:text-white">Collection</span>
                      </a>
                    </li>
                  </ul>}

                </li>
                <li onClick={showDropdown2} className="nav-item dropdown group relative">
                  <a
                    href="#!"
                    className="text-jacarta-700 hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5"
                    aria-expanded="false"
                    ...
                    >
                      ...
                      <li>
                        ...
                        >
                          ...
                          <span className="text-jacarta-700 text-sm dark:text-white">Art</span>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          ...
                          <span className="text-jacarta-700 text-sm dark:text-white">Collectibles</span>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          ...
                          <span className="text-jacarta-700 text-sm dark:text-white">Domain Names</span>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          ...
                          <span className="text-jacarta-700 text-sm dark:text-white">Music</span>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          ...
                          <span className="text-jacarta-700 text-sm dark:text-white">Photography</span>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          ...
                          <span className="text-jacarta-700 text-sm dark:text-white">Sports</span>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          ...
                          <span className="text-jacarta-700 text-sm dark:text-white">Trading Cards</span>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          ...
                          <span className="text-jacarta-700 text-sm dark:text-white">Utility</span>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          ...
                          <span className="text-jacarta-700 text-sm dark:text-white">Virtual Worlds</span>
                        </a>
                      </li>
                    </ul>
                  }
                  ...
                  >
                    <li>
                      <a
                        ...
                        className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                      >
                        <span className="text-jacarta-700 text-sm dark:text-white">Help Center</span>
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                      >
                        <span className="text-jacarta-700 text-sm dark:text-white">Blog</span>
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                      >
                        <span className="text-jacarta-700 text-sm dark:text-white">Single Post</span>
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                      >
                        <span className="text-jacarta-700 text-sm dark:text-white">Newsletter</span>
                      </a>
                    </li>
                  </ul>
                </li>
