          ...
          <MenuContainer>
            ...
            <nav className="navbar w-full">
              <ul className="flex flex-col lg:flex-row">
                ...
                <li className="group relative">
                  <Link href="/about">
                    <a className="text-jacarta-700 hover:text-accent focus:text-accent text-lg font-semibold dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 dark:text-white lg:px-5"
                    >
                      About
                    </a>
                  </Link>
                ...
                <li onClick={showDropdown2} className="group relative">
                      ...
                      <li>
                        <Link href="/blog">
                          <a
                            className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                          >
                            <span className="text-jacarta-700 text-[1.125rem] tracking-wider dark:text-white">Blog</span>
                          </a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/past-awards">
                          <a
                            className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                          >
                            <span className="text-jacarta-700 text-[1.125rem] tracking-wider dark:text-white">Past Awards</span>
                          </a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/sponsorship">
                          <a
                            className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors"
                          >
                            <span className="text-jacarta-700 text-[1.125rem] tracking-wider dark:text-white">Sponsorship</span>
                          </a>
                        </Link>
                      </li>
                    </ul>
