...
const About = () => {
    return (
        <section className={classNames("relative md:py-6 py-2 bg-white dark:bg-jacarta-800 text-jacarta-700 dark:text-white", { "object-cover object-[83%]  bg-cover bg-center bg-[url('/assets/images/gradient_light.jpg')] ": switchColor })}>
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px] xl:gap-24">
                    ...
                    <div className="lg:col-span-7 md:col-span-6 mt-8 md:mt-0">
                        <div className="lg:ml-5">
                            ...
                            <p className="max-w-[38.9375rem] xl:text-lg">Founded in 2012, the Nigerian Fintech Awards are dedicated to honoring excellence in financial technologies and services companies and products. The Awards provide public recognition for the achievements of FinTech companies and products in many categories. These include Payments, Personal Finance, Wealth Management, Fraud Protection, Banking, Lending, RegTech, InsurTech, and more. Nigerian Fintech Awards has no tie with any Fintech company. </p>
                            <p className="max-w-[38.9375rem] xl:text-lg pt-1">This means that our decisions and actions are independent of any interest or operational restrictions. The ethos of the awards is in line with this freedom. Emaginations promotes the Nigerian Fintech Awards.</p>
