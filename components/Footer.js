...
function Footer() {
  return (
    <>
      ...
      <footer className=" bg-white dark:bg-jacarta-800 text-jacarta-700 dark:text-white footer-section relative footer-shape pb-20 lg:pb-28 pt-40 lg:pt-56">
        <div className="container mx-auto relative px-4 z-10">
          ...
          <div className="lg:text-center mt-8 lg:mt-10">
            <p className="font-body text-sm text-jacarta-700">
